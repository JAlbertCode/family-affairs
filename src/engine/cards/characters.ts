...
export const CHARACTERS: CharacterDef[] = [
  ...
  // Her pot pie has been in the deck since the beginning. She had not.
  {
    ...
    startsWith: ['potpie'],
    passive: {
      name: 'The Ornament Collection',
      text: 'Every time somebody at the table hands her something, Titi Evelyn keeps a piece of them. Three at a time, and each one remembers whose it was. The rest of her kit is what she does with them.',
      hooks: ['ornaments', 'hostess'],
    },
    ability: {
      name: 'Borrowed Spark',
      text: 'Break the newest ornament. Whoever gave it to her, she has their best number for the Round. You gave it to her. Of course she kept it.',
      actionCost: 1,
      engine: 'Reads the ornament collection - which Character it came from, and what their best stat is right now.',
      effects: [],
    },
    powerMove: {
      name: 'Trim The Tree',
      text: 'Every ornament goes up. Everybody hanging on the tree gets their best number back, and so does she. Three different people up there and the whole family is healed and shakes something off.',
      actionCost: 1,
      oncePerGame: true,
      engine: 'Reads the whole ornament collection and pays out to every Character represented on it.',
      effects: [],
    },
    flaw: {
      name: 'Too Much Fun',
