...
export const STUFF: StuffDef[] = [
  ...
  },
  {
    ...
    activated: {
      name: 'Hammer Time',
      text: 'Deal 3 damage to a chosen enemy. Cooldown 2 Rounds.',
      actionCost: 1,
      cooldown: 2,
      effects: [{ k: 'damage', target: { scope: 'chosenEnemyActive' }, amount: 3 }],
    },
  ...
  },
  {
    ...
    activated: {
      name: 'Sleep It Off',
      text: 'Heal a chosen ally 3 and clear Asleep, Confused and Busy. Cooldown 2 Rounds.',
      actionCost: 1,
      cooldown: 2,
      effects: [
        { k: 'heal', target: { scope: 'chosenAllyActive' }, amount: 3 },
        { k: 'removeStatus', target: { scope: 'chosenAllyActive' }, status: 'Asleep' },
        { k: 'removeStatus', target: { scope: 'chosenAllyActive' }, status: 'Confused' },
  ...
  {
    kind: 'stuff', id: 'ducttape', name: 'Duct Tape', subtype: 'Consumable', copies: 3, icon: '🩹', color: UTIL,
    text: 'It is not a repair, it is a decision. A chosen enemy is Busy until their next Turn: no attacking, no items, no stepping in for anybody.',
    effects: [{ k: 'status', target: { scope: 'chosenEnemyActive' }, status: 'Busy', duration: 1 }],
  },
  {
    ...
    activated: {
      name: 'Drill Through',
      text: 'Deal 3 damage to a chosen enemy, ignoring Defense. Cooldown 2 Rounds.',
      actionCost: 1,
      cooldown: 2,
      effects: [{ k: 'damage', target: { scope: 'chosenEnemyActive' }, amount: 3, ignoreDefense: true }],
    },
    effects: [],
  },
  {
